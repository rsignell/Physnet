...
public class ProblemSelector implements GeneralData {
    ...
    ProblemSelector(int p, String an, String w, String ac){
        ...
        if (problemNo ==  0) problem = new HangingBall0  ("90", "17", "00");
        if (problemNo ==  1) problem = new HangingBall   ("90", "17", "00");
        if (problemNo ==  2) problem = new PersonHorizS  ("00", "17", "00");
        if (problemNo ==  3) problem = new PersonHorizD  ("00", "16", "10");
        if (problemNo ==  4) problem = new PersonHorizD2 ("00", "16", "10");
        if (problemNo ==  5) problem = new BoxInclineS   ("23", "19", "00");
        if (problemNo ==  6) problem = new BoxInclineS2  ("23", "20", "00");
        if (problemNo ==  7) problem = new PersonIncliS  ("23", "20", "00");
        if (problemNo ==  8) problem = new PersonIncliD  ("23", "20", "10");
        if (problemNo ==  9) problem = new PulleyHorizSB ("00", "17", "00");
        if (problemNo == 10) problem = new PulleyHorizSP ("00", "17", "00");
        if (problemNo == 11) problem = new PulleyHorizSP4("00", "17", "00");
